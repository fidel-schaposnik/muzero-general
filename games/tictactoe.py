...
class MuZeroConfig:
    def __init__(self):
        ...
        self.exploit_symmetries = [True, True, True]  # [Horizontal symmetry, Vertical symmetry, Diagonal symmetry]. Batch size must be divisible by the number symmetries + 1
